...
public class SampleController {
    // 컨트롤러는 url생성과 프론트를 연결하는 부분으로 과거에 servlet-context.xml과 같은 역할을 함
    ...
    @GetMapping("/ex/ex1") // http://192.168.111.105:80/ex/ex1 -> /resouces/templates/ex/ex1.html
    public void ex1(Model model){
        // 리스트 타입으로 데이터를 보내보자
        List<String> list = Arrays.asList("김기원", "이현우", "양지민", "박채은", "홍경훈");
    ...
    @GetMapping("/ex/ex2") // http://192.168.111.105:80/ex/ex2 -> /resouces/templates/ex/ex2.html
    public void ex2(Model model){
        ...
        // 리턴타입이 void 임으로 /resources/templates/ex/ex2.html -> /resouces/templates/ex/ex3.html
